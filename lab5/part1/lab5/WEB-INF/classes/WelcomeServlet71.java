...
out.println("<HTML>");
out.println("<HEAD>");
out.println("<TITLE>Display All Authors</TITLE>");
 out.println("</HEAD>"); 
out.println("<BODY>"); 
out.println("<CENTER>");
out.println("<BR><H2>Displaying All Authors</H2>");
out.println("<BR>");
out.println("<BR>");
out.println("<BR><FORM METHOD=POST>");
out.println("<TABLE>");
out.println("<TR>");
out.println("<TH>ID_A</TH>");
...
sql = "SELECT ID_A, SURNAME FROM AUTHOR";
...
response.sendRedirect("http://localhost:4444/myApp/LoginServ11");
}}
